...
<center>sources: https://github.com/topepo/2025_BC_CDC</center>

<br>

<center>slides: https://topepo.github.io/2025_BC_CDC</center>
...
See the [developer documentation](https://www.tidymodels.org/learn/#category=developer%20tools).
...
# Good: 
predict(mod_fit, delivery_val) |> slice(1:3)

# Better:
augment(mod_fit, delivery_val) |> slice(1:3) |> select(1:3)
```
